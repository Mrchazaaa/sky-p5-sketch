(function () {
  ...
  const { createSceneAssets } = window.SkySketchAssets;
  const CloudLayer = window.SkySketchCloudLayer;
  const MoonLayer = window.SkySketchMoonLayer;
  const MountainLayer = window.SkySketchMountainLayer;
